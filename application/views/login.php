...
<body >
<div class="container" style="margin-top: 50px ; background-image: url('assets/img/01.jpg'); background-size: 1170px; background-position: center;" >
    <div class="row">
        <div class="col-sm-6 col-md-4 col-md-offset-4">
            <h1 class="text-center login-title">Masuk Administrator</h1>
            <?php if(isset($error1)) { echo $error1; }; ?>
            <div class="account-wall">
                <img class="profile-img" src="<?php echo base_url('assets/img/01.jpg') ?>"
                    alt="">    
                ...
                <button class="btn btn-lg btn-primary btn-block" name="#" id="btn-login" type="submit">
                    keluar</button>
